...
if __name__ == "__main__":
    ...
    policy_tag = "sparse" if COLLECTOR["impulse_policy"] == True else "noise"
    ...
    csv_path = Path(f"temp_jac/jacobian_results_{env_tag}_{parser.num_points}_{policy_tag}_{vae_tag}.csv")
